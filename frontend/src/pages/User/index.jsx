                                ...
                                <Card.Text>
                                    <Row>
                                        <InputGroup className="mt-3">
                                            <InputGroup.Text id="full-name" style={{ width: '160px' }}>Nama Lengkap</InputGroup.Text>
                                        ...
                                        <InputGroup className="mt-3">
                                            <InputGroup.Text id="date-of-birth" style={{ width: '160px' }}>Tanggal Lahir</InputGroup.Text>
                                        ...
                                        <InputGroup className="mt-3">
                                            <InputGroup.Text id="gender" style={{ width: '160px' }}>Jenis Kelamin</InputGroup.Text>
                                        ...
                                        <InputGroup className="mt-3">
                                            <InputGroup.Text id="address" style={{ width: '160px' }}>Alamat</InputGroup.Text>
                                        ...
                                        <InputGroup className="mt-3">
                                            <InputGroup.Text id="phone-number" style={{ width: '160px' }}>Nomor Telepon</InputGroup.Text>
